...
public class HiloServidorAdivina extends Thread {
    ...
    public void run() 
    {
        ...
        if (objeto.seAcabo()) 
        {
            datos.setCadena("El juego ya ha finalizado, has adivinado el número!");
            datos.setJuega(false); //ya no se puede jugar
        }
        ...
        if (objeto.seAcabo()) 
        {
            ...
            System.out.println("\tDesconectados: " + identificador);
        }
